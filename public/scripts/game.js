...
game.checkDraw = () => {
   const allCells = ['tFirst','mFirst','bFirst','tSecond','mSecond','bSecond','tThrid','mThird','bThird'];
   let i = 0;
...
game.display = () => {
   ...
   for(const board of createBoard){
      const doneBoard = {main:'#main-body',type:'div',cn:'boardSet',id:board};
