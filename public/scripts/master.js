...
app.thankYou = () => {
   ...
   const main = [{main:'main',type:'section',cn:'thanks-holder'},{main:'.thanks-holder',type:'h1',text:"Thank you for reaching out.  I will make sure to reply to your message as soon as I can.  You can also add my contact address as spriggsjohnw@gmail.com"}]
   app.removeAll('header');
   app.removeAll('main');
